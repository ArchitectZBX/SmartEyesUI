...
PPPPChannelManagement::PPPPChannelManagement()
{
...
int PPPPChannelManagement::Start(const char * szDID, const char *user, const char *pwd)
{ 
    [m_Lock lock];
...
int PPPPChannelManagement::Stop(const char * szDID)
{
    [m_Lock lock];
...
void PPPPChannelManagement::StopAll()
{    
    [m_Lock lock];
...
int PPPPChannelManagement::StartPPPPAudio(const char *szDID)
{
    [m_Lock lock];
...
int PPPPChannelManagement::StopPPPPAudio(const char *szDID)
{
    [m_Lock lock];
...
int PPPPChannelManagement::StartPPPPTalk(const char *szDID)
{
    [m_Lock lock];
...
int PPPPChannelManagement::StopPPPPTalk(const char *szDID)
{
    [m_Lock lock];
...
int PPPPChannelManagement::TalkAudioData(const char *szDID, const char *data, int len)
{
    [m_Lock lock];
...
int PPPPChannelManagement::StartPPPPLivestream(const char * szDID, int streamid, id delegate)
{
    [m_Lock lock];
...
int PPPPChannelManagement::StopPPPPLivestream(const char * szDID)
{ 
    [m_Lock lock];
...
int PPPPChannelManagement::GetCGI(const char* szDID, int cgi)
{
    [m_Lock lock];
...
int PPPPChannelManagement::PTZ_Control(const char *szDID, int command)
{
    [m_Lock lock];
...
int PPPPChannelManagement::CameraControl(const char *szDID, int param, int value)
{
    [m_Lock lock];
...
int PPPPChannelManagement::Snapshot(const char *szDID)
{
    [m_Lock lock];
...
void PPPPChannelManagement::SetPlaybackDelegate(char *szDID, id delegate)
{
    [m_Lock lock];
...
int PPPPChannelManagement::PPPPStartPlayback(char *szDID, char *szFileName, int offset)
{
    [m_Lock lock];
...
int PPPPChannelManagement::PPPPGetSDCardRecordFileList(char *szDID, int startTime, int endTime)
{
    [m_Lock lock];
...
int PPPPChannelManagement::PPPPStopPlayback(char *szDID)
{
    [m_Lock lock];
...
int PPPPChannelManagement::PPPPSetSystemParams(char * szDID,int type,char * msg,int len)
{
    [m_Lock lock];
...
int PPPPChannelManagement::SetWifiParamDelegate(char *szDID, id delegate)
{
    [m_Lock lock];
...
int PPPPChannelManagement::SetWifi(char *szDID, int enable, char *szSSID, int channel, int mode, int authtype, int encrypt, int keyformat, int defkey, char *strKey1, char *strKey2, char *strKey3, char *strKey4, int key1_bits, int key2_bits, int key3_bits, int key4_bits, char *wpa_psk)
{
    [m_Lock lock];
...
int PPPPChannelManagement::SetUserPwdParamDelegate(char *szDID, id delegate)
{
...
int PPPPChannelManagement::SetUserPwd(char *szDID,char *user1,char *pwd1,char *user2,char *pwd2,char *user3,char *pwd3)
{
    [m_Lock lock];
...
int PPPPChannelManagement::SetDateTimeDelegate(char *szDID, id delegate)
{
    [m_Lock lock];
...
int PPPPChannelManagement::SetDateTime(char *szDID,int now,int tz,int ntp_enable,char *ntp_svr)
{
    [m_Lock lock];
...
int PPPPChannelManagement::SetAlarmDelegate(char *szDID, id delegate)
{
    [m_Lock lock];
...
int PPPPChannelManagement::SetSDCardSearchDelegate(char *szDID, id delegate)
{
    [m_Lock lock];
...
int PPPPChannelManagement::SetMailDelegate(char *szDID, id delegate)
{
    [m_Lock lock];
...
int PPPPChannelManagement::SetMail(char *szDID, char *sender, char *smtp_svr, int smtp_port, int ssl, int auth, char *user, char *pwd, char *recv1, char *recv2, char *recv3, char *recv4)
{
    [m_Lock lock];
...
int PPPPChannelManagement::SetFTPDelegate(char *szDID, id delegate)
{
    [m_Lock lock];
...
int PPPPChannelManagement::SetFTP(char *szDID, char *szSvr, char *szUser, char *szPwd, char *dir, int port, int uploadinterval, int mode)
{
    [m_Lock lock];
...
int PPPPChannelManagement::SetAlarm(char *szDID,
                                     int motion_armed,
...
int PPPPChannelManagement::SetSDcardScheduleDelegate(char *szDID, id delegate){
    [m_Lock lock];
...
int PPPPChannelManagement::SetSDcardScheduleParams(char *szDID,//UID
