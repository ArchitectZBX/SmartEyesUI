...
{    
    while(m_bCommandRecvThreadRuning)
    {
        ...
        if(cmdhead.cmd == a && strcmp(pbuf, "result= 0")) {
            [[NSNotificationCenter defaultCenter] postNotificationName:@"startVideoNotification" object:nil];
        }
